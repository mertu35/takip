...
import type { AppUser, Category, Product, Customer, Sale, LogEntry } from "../types";
...
export const INITIAL_PRODUCTS: Product[] = [
  { id: "prod-1", code: "OFIS-001", name: "A4 Fotokopi Kağıdı (80gr)", categoryId: "cat-1", categoryName: "Ofis Malzemeleri", price: 180, stock: 75, criticalStock: 20, unit: "Adet", createdAt: new Date().toISOString() },
  { id: "prod-2", code: "OFIS-002", name: "Pilot Kalem (Mavi)", categoryId: "cat-1", categoryName: "Ofis Malzemeleri", price: 35, stock: 12, criticalStock: 25, unit: "Adet", createdAt: new Date().toISOString() },
  { id: "prod-3", code: "ELK-001", name: "Kablosuz Optik Mouse", categoryId: "cat-2", categoryName: "Elektronik", price: 450, stock: 15, criticalStock: 5, unit: "Adet", createdAt: new Date().toISOString() },
  { id: "prod-4", code: "ELK-002", name: "24\" LED Monitör", categoryId: "cat-2", categoryName: "Elektronik", price: 4200, stock: 4, criticalStock: 5, unit: "Adet", createdAt: new Date().toISOString() },
  { id: "prod-5", code: "GIDA-001", name: "Rize Çayı (1 Kg)", categoryId: "cat-3", categoryName: "Gıda & Tüketim", price: 220, stock: 3, criticalStock: 10, unit: "Adet", createdAt: new Date().toISOString() },
  { id: "prod-6", code: "MOB-001", name: "Ergonomik Çalışma Sandalyesi", categoryId: "cat-4", categoryName: "Mobilya", price: 2950, stock: 18, criticalStock: 4, unit: "Adet", createdAt: new Date().toISOString() }
];

export const INITIAL_CUSTOMERS: Customer[] = [
  { id: "cust-1", name: "Ahmet Yılmaz", company: "Yılmaz İnşaat Taahhüt Ltd. Şti.", phone: "0532 111 22 33", email: "ahmet@yilmazinsaat.com", taxOffice: "Maslak", taxNumber: "9876543210", address: "Büyükdere Cad. No:123/4 Sarıyer/İstanbul", createdAt: new Date().toISOString() },
  { id: "cust-2", name: "Mehmet Kaya", company: "Kaya Teknoloji ve Bilişim San. Tic. A.Ş.", phone: "0212 555 44 33", email: "satinalma@kayatech.com", taxOffice: "Kadıköy", taxNumber: "1234567890", address: "Atatürk Cad. No:45 Kat:3 Kadıköy/İstanbul", createdAt: new Date().toISOString() },
  { id: "cust-3", name: "Ayşe Demir", company: "Demir Lojistik Hizmetleri A.Ş.", phone: "0544 333 22 11", email: "ademir@demirlojistik.com", taxOffice: "Tuzla", taxNumber: "5556667778", address: "Orhanlı Mah. Lojistik Sok. No:12 Tuzla/İstanbul", createdAt: new Date().toISOString() }
];
