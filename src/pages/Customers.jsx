...
const statusLabel = (s) => s === "approved" ? "Onaylandı" : s === "rejected" ? "Reddedildi" : "Bekliyor";
const statusBadge = (s) => s === "approved" ? "success" : s === "rejected" ? "danger" : "warning";
...
const Customers = () => {
  ...
  // Satış geçmişi özet istatistikleri
            ...
            {historyStats && !historyLoading && (
              <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "1rem", padding: "1rem 1.5rem", borderBottom: "1px solid var(--border-color)", flexShrink: 0 }}>
                <div style={{ textAlign: "center", padding: "0.75rem", backgroundColor: "var(--bg-secondary)", borderRadius: "var(--radius-sm)" }}>
                  ...
                  <div style={{ fontSize: "0.75rem", color: "var(--text-muted)" }}>Toplam Satış</div>
                </div>
                <div style={{ textAlign: "center", padding: "0.75rem", backgroundColor: "var(--bg-secondary)", borderRadius: "var(--radius-sm)" }}>
                  <div style={{ fontSize: "1.4rem", fontWeight: 800, color: "var(--success)" }}>{historyStats.approvedCount}</div>
                  <div style={{ fontSize: "0.75rem", color: "var(--text-muted)" }}>Onaylanan</div>
                </div>
                <div style={{ textAlign: "center", padding: "0.75rem", backgroundColor: "var(--bg-secondary)", borderRadius: "var(--radius-sm)" }}>
                  <div style={{ fontSize: "1.1rem", fontWeight: 800, color: "var(--primary)" }}>
                    {historyStats.totalRevenue.toLocaleString('tr-TR', { minimumFractionDigits: 2 })} ₺
                  </div>
                  <div style={{ fontSize: "0.75rem", color: "var(--text-muted)" }}>Toplam Ciro</div>
                </div>
                <div style={{ textAlign: "center", padding: "0.75rem", backgroundColor: "var(--bg-secondary)", borderRadius: "var(--radius-sm)" }}>
                  ...
                  <div style={{ fontSize: "0.75rem", color: "var(--text-muted)" }}>Toplam KDV</div>
                </div>
              </div>
            )}
